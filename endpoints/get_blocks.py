...
@app.get("/blocks/{blockId}", response_model=BlockModel, tags=["Gor blocks"])
...
@app.get("/blocks", response_model=BlockResponse, tags=["Gor blocks"])
...
@app.get("/blocks-from-bluescore", response_model=List[BlockModel], tags=["Gor blocks"])
