...
@app.get("/blocks/{blockId}", response_model=BlockModel, tags=["Brics blocks"])
...
@app.get("/blocks", response_model=BlockResponse, tags=["Brics blocks"])
...
@app.get("/blocks-from-bluescore", response_model=List[BlockModel], tags=["Brics blocks"])
